...
tap.test("parse", async function() {
  ...
  tap.test("parse path for price of everything in the store", async function() {
  ...
  tap.test("parse path to filter all books with isbn number", async function() {
...
tap.test("parse-negative", async function() {
  tap.test("parse path with leading member component throws", async function() {
